...
import com.wujiawei.business.domain.TrainStation;
import com.wujiawei.business.domain.TrainStationExample;
import com.wujiawei.business.mapper.TrainStationMapper;
...
public class TrainStationService {
    ...
    public void save(TrainStationSaveReq req) {
        ...
        if (ObjectUtil.isNull(trainStation.getId())) {
            ...
            TrainStation trainStationDB= UniqueQueryUtil.selectByUnique(TrainStationExample::new,
                    example -> {
            ...
            if (ObjectUtil.isNull(trainStationDB)) {
    ...
    public PageResp<TrainStationQueryResp> queryList(TrainStationQueryReq req) {
        ...
        if(ObjectUtil.isNotNull(req.getTrainCode())){
            criteria.andTrainCodeLike("%"+req.getTrainCode()+"%");
        }
